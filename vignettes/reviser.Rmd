...
Some agencies **fix** their data after a certain period (e.g., Germany finalizes GDP data in August four years after the initial release, while the UK stops revisions after 36 months). The function `get_fixed_release()` extracts these fixed releases.
...
gdp_releases <- get_nth_release(gdp_ea_longer, n = 12)
gdp_releases
